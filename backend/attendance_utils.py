...
def generate_dtr(employee_name, employee_data, template_path=None, approver_name="", period_text="", period_format="full"):
...
def generate_dtr_adjustment_slip(employee_data, output_path, overrides={}):
    template_path = os.path.join(os.path.dirname(__file__), 'template_files', 'DTR_AS_template.docx')
